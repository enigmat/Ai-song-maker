...
const UploadIcon = () => (
  <svg className="w-12 h-12 mx-auto text-gray-500" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
    ...
    <path d="M20 25v12m-6-6h12" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);


export const PromptForm: React.FC<FileUploadProps> = ({ onFileSelect, onConvert, file, isLoading }) => {
          ...
          {isLoading ? (
            ...
            <>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 4H4v5M15 20h5v-5" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 20H4v-5M15 4h5v5" />
